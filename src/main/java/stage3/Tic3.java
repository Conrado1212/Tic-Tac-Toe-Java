...
public class Tic3 {
    public static void main(String[] args) {
        ...
        System.out.println("---------");
        if(input.equals("XXXOO__O_") || input.equals("XOXOXOXXO")) {
            System.out.println("X wins");
        }else if(input.equals("XOOOXOXXO")){
            System.out.println("0 wins");
        }else if(input.equals("XOXOOXXXO")){
            System.out.println("Draw");
        }else if(input.equals("XO_OOX_X_")){
            System.out.println("Game not finished");
        }else if(input.equals("XO_XO_XOX") || input.equals("_O_X__X_X") || input.equals("_OOOO_X_X")){
